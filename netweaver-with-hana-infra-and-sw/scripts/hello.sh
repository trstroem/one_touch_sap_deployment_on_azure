...
az deployment group create  --resource-group $5 --template-uri "https://raw.githubusercontent.com/trstroem/one_touch_sap_deployment_on_azure/master/hana-db-single-node-infra-and-sw/jumpbox-windows-deploy.json" --parameters adminUsername='juser' adminPassword='Welcome@123' windowsOSVersion='2016-Datacenter' vmSize='Standard_D2_v3' location=$6 vNetName=$7
